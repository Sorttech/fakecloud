...
#[test_action("glue", "CreateGlossary", checksum = "49641300")]
#[test_action("glue", "GetGlossary", checksum = "99483e6f")]
#[test_action("glue", "UpdateGlossary", checksum = "273fe005")]
#[test_action("glue", "DeleteGlossary", checksum = "89a8eff7")]
#[test_action("glue", "ListGlossaries", checksum = "ff5de9ed")]
#[test_action("glue", "CreateGlossaryTerm", checksum = "745565f2")]
#[test_action("glue", "GetGlossaryTerm", checksum = "33d4f2f3")]
#[test_action("glue", "UpdateGlossaryTerm", checksum = "ad1bfd5d")]
#[test_action("glue", "DeleteGlossaryTerm", checksum = "04c18834")]
#[test_action("glue", "ListGlossaryTerms", checksum = "deed9961")]
#[test_action("glue", "AssociateGlossaryTerms", checksum = "51380c87")]
#[test_action("glue", "DisassociateGlossaryTerms", checksum = "dfa97b54")]
#[test_action("glue", "PutAsset", checksum = "ae7ccd37")]
#[test_action("glue", "GetAsset", checksum = "f88673df")]
#[test_action("glue", "DeleteAsset", checksum = "39044e06")]
#[test_action("glue", "SearchAssets", checksum = "7145649b")]
#[test_action("glue", "PutAssetType", checksum = "179b7a8f")]
#[test_action("glue", "GetAssetType", checksum = "58cf5274")]
#[test_action("glue", "DeleteAssetType", checksum = "03a23025")]
#[test_action("glue", "ListAssetTypes", checksum = "87ea2deb")]
#[test_action("glue", "PutFormType", checksum = "49ecd590")]
#[test_action("glue", "GetFormType", checksum = "81cec601")]
#[test_action("glue", "DeleteFormType", checksum = "731149a9")]
#[test_action("glue", "ListFormTypes", checksum = "ff32d518")]
#[test_action("glue", "PutAttachment", checksum = "b85726b1")]
#[test_action("glue", "DeleteAttachment", checksum = "eafa1b3b")]
#[test_action("glue", "BatchGetIterableForms", checksum = "abf8266f")]
#[test_action("glue", "ListIterableForms", checksum = "a321b09f")]
#[test_action("glue", "GetDataCatalogExportConfiguration", checksum = "a0a641ee")]
#[test_action("glue", "PutDataCatalogExportConfiguration", checksum = "0f9a269b")]
