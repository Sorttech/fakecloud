...
impl TestServer {
    ...
    pub async fn bedrock_agent_client(&self) -> aws_sdk_bedrockagent::Client {
    ...
    pub async fn eks_client(&self) -> aws_sdk_eks::Client {
        aws_sdk_eks::Client::new(&self.aws_config().await)
    }
    ...
    pub async fn acm_client(&self) -> aws_sdk_acm::Client {
    ...
    pub async fn wafv2_client(&self) -> aws_sdk_wafv2::Client {
        aws_sdk_wafv2::Client::new(&self.aws_config().await)
    }

    pub async fn athena_client(&self) -> aws_sdk_athena::Client {
    ...
    pub async fn cloudwatch_client(&self) -> aws_sdk_cloudwatch::Client {
        aws_sdk_cloudwatch::Client::new(&self.aws_config().await)
    }

    pub async fn organizations_client(&self) -> aws_sdk_organizations::Client {
        aws_sdk_organizations::Client::new(&self.aws_config().await)
    }
